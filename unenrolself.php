<?php
/**
 * Telr enrolment plugin - support for user self unenrolment.
 *
 * @package    enrol_telr
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'telr'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/telr/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_telr', format_string($course->fullname));
